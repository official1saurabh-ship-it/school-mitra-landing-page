...
const TransportManagement = () => {
  ...
  const features = [
    { title: "Route Management", icon: Map, desc: "Design and optimize school bus routes for maximum coverage and fuel efficiency." },
    { title: "Vehicle Tracking", icon: Navigation, desc: "Real-time GPS tracking of school vehicles to ensure student safety and timely arrivals." },
    { title: "Driver Details", icon: UserCircle, desc: "Maintain comprehensive records of drivers, including licenses, contact info, and history." },
    { title: "Pickup / Drop Points", icon: MapPin, desc: "Easily define and manage specific stops and timings for every student on each route." }
  ];
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20">
          ...
          <div className="max-w-3xl">
            <h1 className="text-5xl lg:text-7xl font-black text-white leading-tight mb-6">
              Transport <span className="text-blue-600">Management</span>
            </h1>
            <p className="text-xl text-slate-400 font-medium leading-relaxed">
              Safety first. Monitor your school's fleet in real-time and provide parents with peace of mind regarding their child's commute.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto bg-slate-950 rounded-[3rem] p-12 lg:p-20 text-center relative overflow-hidden">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white mb-8 relative z-10">Ensure Safer Commutes Today</h2>
