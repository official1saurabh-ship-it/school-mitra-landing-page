...
const HostelManagement = () => {
  ...
  const features = [
    { title: "Room Allocation", icon: Bed, desc: "Efficiently manage room availability and automate the allocation process for students." },
    { title: "Hostel Fees", icon: Wallet, desc: "Manage hostel-specific fee structures, room rent, and mess charges seamlessly." },
    { title: "Attendance", icon: UserCheck, desc: "Track daily presence and night attendance for hostel residents with real-time reporting." }
  ];
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20">
          ...
          <div className="max-w-3xl">
            <h1 className="text-5xl lg:text-7xl font-black text-white leading-tight mb-6">
              Hostel <span className="text-blue-600">Management</span>
            </h1>
            <p className="text-xl text-slate-400 font-medium leading-relaxed">
              A home away from home, managed efficiently. Ensure student safety and comfort while streamlining residential operations.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto bg-slate-950 rounded-[3rem] p-12 lg:p-20 text-center relative overflow-hidden">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white mb-8 relative z-10">Manage Your Residential Facilities Better</h2>
