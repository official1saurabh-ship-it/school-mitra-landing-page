...
const Administration = () => {
  ...
  const features = [
    { title: "Role & Permissions", icon: ShieldCheck, desc: "Granular access control to ensure data security. Define what each staff member can see and do." },
    { title: "User Management", icon: Users2, desc: "Centralised hub to manage accounts for administrators, teachers, students, and parents." },
    { title: "Multi-School Support", icon: Building2, desc: "Manage multiple school branches or campuses from a single unified super-admin dashboard." },
    { title: "ID Card Generation", icon: Contact, desc: "Bulk generate and print professional student and staff ID cards with custom templates." },
    { title: "Certificates (TC/Bonafide)", icon: FileBadge, desc: "Automate the issuance of Transfer Certificates, Bonafide certificates, and other official documents." },
    { title: "Document Management", icon: FolderLock, desc: "Securely store and manage school legal documents, student files, and staff records digitally." }
  ];
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-20">
          ...
          <div className="max-w-3xl">
            <h1 className="text-5xl lg:text-7xl font-black text-white leading-tight mb-6">
              Core <span className="text-blue-600">Administration</span>
            </h1>
            <p className="text-xl text-slate-400 font-medium leading-relaxed">
              Powerful tools for the modern school administrator. Centralise your operations, secure your data, and manage your institution with confidence.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto bg-slate-950 rounded-[3rem] p-12 lg:p-20 text-center relative overflow-hidden">
          ...
          <h2 className="text-4xl md:text-6xl font-black text-white mb-8 relative z-10">Streamline Your Governance</h2>
