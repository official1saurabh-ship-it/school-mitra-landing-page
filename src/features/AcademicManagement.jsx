  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      ...
      <section className="relative h-[40vh] min-h-[600px] flex items-center bg-slate-950 overflow-hidden">
        ...
        <div className="w-full max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
      ...
      {/* Features Grid */}
      <section className="py-24 w-full max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-screen-2xl mx-auto bg-slate-950 rounded-[3rem] p-12 lg:p-20 text-center relative overflow-hidden">
